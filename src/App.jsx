      ...
      >
        <div class="max-w-4xl mx-auto">
          ...
          <div class="bg-white p-6 rounded-lg shadow-md mb-8">
            <form onSubmit={saveTask} class="flex space-x-4">
              <input
                type="text"
                placeholder="New Task"
                value={newTask()}
                onInput={(e) => setNewTask(e.target.value)}
                class="flex-1 p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-400 focus:border-transparent box-border"
                required
              />
              <button
                type="submit"
          ...
          <Show when={aiSuggestions().length}>
            <div class="bg-white p-6 rounded-lg shadow-md mb-8">
              <h2 class="text-2xl font-bold mb-4 text-green-600">AI Suggestions</h2>
          ...
          <div class="bg-white p-6 rounded-lg shadow-md">
            <h2 class="text-2xl font-bold mb-4 text-green-600">Your Tasks</h2>
